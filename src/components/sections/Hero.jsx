...
const metrics = [
  { value: "160+", label: "year clinic legacy supported" },
  { value: "3 mo", label: "to ship automation pipelines" },
  { value: "Data + Dev", label: "analytics, engineering, React" },
];
  ...
  return (
    <section id="hero" className="min-h-[calc(100vh-80px)] pt-16 pb-16 flex items-center">
      <div className="section-shell grid lg:grid-cols-[1.08fr_0.92fr] gap-10 lg:gap-14 items-center">
        ...
        >
          <div className="section-label">Senior Data Analyst</div>
          <h1 className="mt-5 text-4xl sm:text-5xl lg:text-7xl font-black leading-[0.98] tracking-normal">
            Rohit Prasad builds reliable data systems for operational decisions.
          </h1>
          <p className="muted-copy mt-6 text-base sm:text-lg max-w-2xl">
            Data analyst in Kolkata focused on data quality automation, Google Apps Script pipelines,
            healthcare analytics, and full-stack tools that make teams faster and data more trustworthy.
          </p>
            ...
            <div className="relative overflow-hidden rounded-lg border border-slate-700/70 bg-slate-900">
              ...
              <div className="absolute left-4 right-4 bottom-4 panel bg-slate-950/86 p-4">
                ...
                <p className="mt-2 text-sm text-slate-200">
                  Automating extraction, validation, and reporting workflows for healthcare data.
                </p>
              </div>
            </div>
